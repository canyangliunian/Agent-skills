...
\usepackage{xeCJK} % 确保 XeLaTeX 下启用 CJK 字体切换

% 让 beamer 不覆盖你设定的系统字体
\usefonttheme{professionalfonts}

% 英文：Times（同时把 sans 也设成 Times，避免 beamer 默认走 sans）
\setmainfont{Times New Roman}
\setsansfont{Times New Roman}
\setmonofont{Courier New} % 代码/等宽字体用它（你也可以换 Menlo）

% 中文：全篇楷书
\setCJKmainfont{Fsong_GB2312.ttf}[Path=/Library/Fonts/,AutoFakeBold=2]
\setCJKsansfont{Kaiti_GB2312.ttf}[Path=/Library/Fonts/,AutoFakeBold=2]
\setCJKmonofont{Fsong_GB2312.ttf}[Path=/Library/Fonts/,AutoFakeBold=2]

% 如果你希望 URL 也不要“打字机体”，用正文同款：
\urlstyle{same}
%%%%%%%%%%额外加的%%%%%%%%%%%%
...
% 【修改点1】禁止在每个 section 开始时自动生成目录页或过渡页
\AtBeginSection[]{}
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.4\linewidth]{pic/南京农业大学.eps}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{用Beamer很高大上？}
    \begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
        ...
        \item Overleaf项目地址位于 \url{https://www.overleaf.com/latex/templates/ruc-beamer-theme/ssryphkjpyjt}，可以直接使用
...
\begin{frame}
    \begin{itemize}
        ...
        \item 但是最初的 \href{http://far.tooold.cn/post/latex/beamertsinghua}{\color{purple}{link}} \cite{duvivierDoesUrbanProximity2013}已经失效了
