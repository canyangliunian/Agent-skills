...
Examples (absolute paths recommended):
  # Recommend (default)
  python3 /Users/lingguiwang/Documents/Coding/LLM/09ABS/scripts/abs_journal.py \\
  ...
  export AJG_PASSWORD="..."
  python3 /Users/lingguiwang/Documents/Coding/LLM/09ABS/scripts/abs_journal.py \\
    recommend --update --data_dir /Users/lingguiwang/Documents/Coding/LLM/09ABS/assets/data \\
    --title "..." --abstract "..."
"""
...
def main() -> int:
    ...
    ap_rec.add_argument("--data_dir", default=os.path.join(REPO_ROOT, "assets", "data"), help="AJG数据目录（绝对路径推荐）")
    ...
    ap_up.add_argument("--data_dir", default=os.path.join(REPO_ROOT, "assets", "data"), help="输出数据目录（绝对路径推荐）")
